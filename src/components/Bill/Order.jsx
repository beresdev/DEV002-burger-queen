      ...
      return (
        <div key={item.id} className='order-element'>
          <div className='counters-buttons'>
            <i className='fa-solid fa-plus' onClick={() => { productOperation(item.id, 'add') }} />
            <p className='counter'>{item.quantity}</p>
            <i className='fa-solid fa-minus' onClick={() => { productOperation(item.id, 'sub') }} />
          </div>
          ...
          <div className='trash-container'>
            <i className='fa-solid fa-trash' onClick={() => { productOperation(item.id, 'del') }} />
          </div>
        </div>
      )
    })
